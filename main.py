...
task1 = Task(
    description = "earch the internet and find 5 promising real estate investment suburbs in Sydney, Australia. For each suburb highlighting the mean, low and max prices as well as the rental yield and any potential factors that would be useful to know for that area. ",
...
task2 = Task(
    description= "Write a report on the best retail properties in Toronto.",
...
crew = Crew([researcher, writer], tasks = [task1, task2], verbose = 2)